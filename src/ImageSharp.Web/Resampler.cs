...
namespace SixLabors.ImageSharp.Web
{
    ...
    /// </summary>
    /// <remarks>
    /// These values are mapped to their enum value in <seealso cref="Processors.ResizeWebProcessor.GetSampler(Commands.CommandCollection)" />.
    /// </remarks>
    public static class Resampler
    {
        ...
        public static ResamplerCommand CatmullRom { get; } = new("catmull");
        ...
        public static ResamplerCommand MitchellNetravali { get; } = new("mitchell");

        /// <inheritdoc cref="KnownResamplers.NearestNeighbor"/>
        public static ResamplerCommand NearestNeighbor { get; } = new("nearest");
